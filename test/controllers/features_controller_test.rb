...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { duration: @feature.duration, name: @feature.name } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { duration: @feature.duration, name: @feature.name } }
